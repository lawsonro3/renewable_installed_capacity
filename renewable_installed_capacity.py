...
ax1.bar(data.year - barWidth / 2, data.water_budget*data.inflation_factor, width = barWidth,label ='Marine Energy Program Budget', color='blue')
# ax2.plot(data.year, data.wind_installed_capacity,color='k',linewidth=2, label='Wind electricity generation', )
ax2.plot(data.year, data.wind_installed_capacity,color='k',linewidth=2, label='Wind Installed Capacity', )
...
ax2.set_ylabel('Wind Installed Capacity (MW)', fontsize=16)
# ax2.set_ylim([0,500])
...
ax4.plot(data_length, data.wind_installed_capacity,color='k',linewidth=2, label='Wind Installed Capacity', )
...
# Adding Xticks
ax3.set_xlabel('Years from Start of Federal Program', fontsize = 16)
ax3.set_ylabel('Inflation Adjusted Budget ($M)', fontsize = 16)
ax4.set_ylabel('Wind Installed Capacity (MW)', fontsize = 16)
